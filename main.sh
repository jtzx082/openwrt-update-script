...
Script By Lenyu	Version v2.1.5

-----------------------------------
>>>菜单主页:
`echo -e "\033[35m 1)检查更新并编译固件\033[0m"`
`echo -e "\033[35m 2)强制更新固件\033[0m"`
...
case $num1 in
    1)
    echo -e "\033[32m >>>检查更新并编译固件-> \033[0m"
    noforce_update
    ;;
    2)
    echo -e "\033[32m >>>强制更新固件-> \033[0m"
    force_update
    ;;
    3)
